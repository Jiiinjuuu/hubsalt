...
import { opportunities } from '../data/mockData' // 공모전 데이터 import
...
export default function Opportunities(){
    ...
    const filtered = useMemo(()=>{
        let list = opportunities // mockData 사용
        ...
        return list
    },[opportunities, activeFilters, sortBy, selectedCategory])
        ...
        <section className="opportunities">
            <div className="container">
                ...
                <div className="op-grid">
                    {paginated.map(item=> <PlaceholderCard key={item.id} item={item} />)}
                </div>
                ...
                <div className="pagination">
                    {Array.from({ length: totalPages }).map((_, i) => (
                        <button
                            key={i}
                            className={`page-btn ${offset / limit === i ? 'active' : ''}`}
